...
class Technician(Base, TimestampMixin):
    ...
    time_slots: Mapped[List["TimeSlot"]] = relationship(
        "TimeSlot", back_populates="technician", cascade="all, delete-orphan"
    )
    appointments: Mapped[List["Appointment"]] = relationship(
        "Appointment", back_populates="technician"
    )
...
class TechnicianServiceArea(Base):
    ...
    technician_id: Mapped[int] = mapped_column(
        ForeignKey("technicians.id"), nullable=False
    )
    ...
    technician: Mapped["Technician"] = relationship(
        "Technician", back_populates="service_areas"
    )
