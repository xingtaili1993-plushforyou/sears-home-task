...
from app.models import Technician, TechnicianServiceArea, TechnicianSpecialty, TimeSlot
...
class TechnicianService:
    ...
    def get_all_technicians(self, active_only: bool = True) -> List[Technician]:
        ...
        query = self.db.query(Technician).options(
            joinedload(Technician.specialties), joinedload(Technician.service_areas)
        )
    ...
    def get_technician_by_employee_id(self, employee_id: str) -> Optional[Technician]:
        ...
        return (
            self.db.query(Technician)
            .filter(Technician.employee_id == employee_id)
            .first()
        )

    def find_technicians_by_criteria(
        self, zip_code: str, appliance_type: str, target_date: Optional[date] = None
    ) -> List[Technician]:
        """
    ...
    def get_service_areas_for_technician(
        ...
        return (
            self.db.query(TechnicianServiceArea)
    ...
    def get_technicians_by_zip_code(self, zip_code: str) -> List[Technician]:
        ...
        return (
            ...
            .options(joinedload(Technician.specialties))
            .all()
        )
    ...
    def get_technicians_by_specialty(self, appliance_type: str) -> List[Technician]:
        ...
        return (
            ...
            .options(joinedload(Technician.service_areas))
            .all()
        )
